  ...
  callWithJQuery(function($) {
    ...
    makeC3Chart = function(chartOpts) {
      ...
      return function(pivotData, opts) {
		  //alert(JSON.stringify(pivotData,2,2));
        ...
        if (chartOpts.type === "scatter") {
          ...
          titleText = pivotData.chartTitle;//fullAggName;
          //if (hAxisTitle !== "") {
            //titleText += " " + opts.localeStrings.vs + " " + hAxisTitle;
          //}
		  ...
		  // commented parts are removed by padam
        }
        title = $("<p>", {
    ...
    return $.pivotUtilities.c3_renderers = {
	  ...
	  // added by padam for EDCD
	  "Combo Chart": makeC3Chart({
        type: "combo"
      })
    };
  });
