  ...
  callWithJQuery(function($) {
    ...
    $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
      ...
      try {
        ...
        rendererControl = $("<td>").addClass('pvtRenderer-cnt');
		var desc = $("<span>").html("Render as: ").appendTo(rendererControl);
        ...
        colList = $("<td>").addClass('pvtAxisContainer pvtUnused').append($("<div>").addClass("dim-cnt").html("Dimensions: "));
        ...
        $("<td>").addClass('pvtVals').append("<span>").html("Value as: ").appendTo(tr1).append(aggregator).append($("<br>"));
